module.exports = {
	'aliasToProperty': new Map([
		...
		['kunihancore2020', 'kUnihanCore2020'],
		['lb', 'Line_Break'],
	...
	'propertyToValueAliases': new Map([
		...
		['Block', new Map([
			...
			['sharada', 'Sharada'],
			['sharadasup', 'Sharada_Supplement'],
			['sharadasupplement', 'Sharada_Supplement'],
			['shavian', 'Shavian'],
		...
		['Line_Break', new Map([
			...
			['surrogate', 'Surrogate'],
			['sy', 'Break_Symbols'],
			['unambiguoushyphen', 'Unambiguous_Hyphen'],
			['unknown', 'Unknown'],
			['vf', 'Virama_Final'],
			['vi', 'Virama'],
			['virama', 'Virama'],
		...
		['Modifier_Combining_Mark', new Map([
			['f', 'No'],
			['false', 'No'],
			['n', 'No'],
			['no', 'No'],
